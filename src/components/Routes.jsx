...
// API Listings
import ClientServices from "../components/Organisms/APIComponents/ClientServices";
import ClientPage from "../components/Organisms/APIComponents/ClientPage";
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/clientpage" element={<ClientPage />} /> {/* 404 page */}
