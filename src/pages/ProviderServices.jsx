    ...
    <>
      ...
      <div className="pages-container">
        ...
        <p>
          ...
          providers. By streamlining the certification, licensing, and surveying
          processes, EDORA empowers providers to focus on what they do
          best—delivering exceptional care to Arkansans. This transformative
          engagement fosters a culture of accountability and excellence that is
          vital for improving service quality.
        </p>
        ...
        <h3 className="dark">4. Enhanced Workforce Development</h3>
        <p>
          Workforce development is crucial for maintaining high-quality care in
        ...
        <p>
          ...
          restrictive settings. By providing a comprehensive view of available
          resources and services, EDORA empowers clients and their families to
          make informed decisions about their care options. Additionally, the
          Lifespan Respite program benefits from EDORA’s robust management
          capabilities, ensuring that respite vouchers are efficiently
        ...
        <p>
          ...
          healthcare landscape; it is setting the standard for excellence in
          service delivery for all Arkansans. Together, let’s build a future
          where quality care is accessible to everyone, and where the commitment
          to improving lives is unwavering.
        </p>
      </div>
    </>
  );
