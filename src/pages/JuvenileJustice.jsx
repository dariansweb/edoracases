  ...
  return (
    <div className="pages-container">
      ...
      <p>
        ...
        intervention, and treatment programs for youth involved in the Arkansas
        juvenile justice system. Our goals are simple: give youth and families
        the opportunities and services they need to be successful in a way that
      ...
      <p>
        ...
        homes and communities. We use different strategies to help youth become
      ...
      <p>
        ...
        have a voice in their treatment and are active in treatment as they are
        critical to youth success.
      </p>
      ...
      <ul>
        <li>
          ...
          monitors contracts and ensures vendors, including the private company
          that handles the day-to-day management of our residential treatment
          centers.
        </li>
        <li>
          <strong>Treatment</strong> – assesses every youth committed to DYS to
          determine their treatment needs, including medical, mental health, and
          substance abuse issues. The same unit monitors the youth’s progress
          and adjusts the plans as necessary to allow the youth to successfully
        ...
        <li>
          ...
          post-graduate educational services that will help students meet their
          academic, college, career, and vocational goals.
        </li>
      </ul>
    </div>
  );
