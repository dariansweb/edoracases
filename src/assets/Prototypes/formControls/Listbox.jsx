...
const ListboxPrototype = () => {
  ...
  useEffect(() => {
    const items = [];
    if (selectedFruit) items.push({ label: `Fruit: ${selectedFruit}`, value: selectedFruit });
    if (selectedColor) items.push({ label: `Color: ${selectedColor}`, value: selectedColor });
    if (selectedSize) items.push({ label: `Size: ${selectedSize}`, value: selectedSize });
  ...
  return (
    <div className='pages-container'>
      <h1 className="dark">ListBox Types</h1>
